...
There's also the possibility to start your sandbox in detached dev mode and keep watching for changes as you develop using the webpack starter.

To *start* your sandbox in that mode and also *watch* for changes as you code, run this command from your shell:
